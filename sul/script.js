...
let sounds = {
    green: new Audio('sons/GRILOSNOCAMPO.wav'),
    red: new Audio('sons/CHURRASCO.wav'),
    yellow: new Audio('sons/QUEROQUERO.wav'),
    blue: new Audio('sons/CAVALOS.wav'),
    orange: new Audio('sons/VANEIRA.wav'),
